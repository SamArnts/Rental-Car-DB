            ...
            <script> 
                ...
                function submit() {
                    if (document.getElementById("car").checked) {
                        window.location = "man_search_car.php";
                    }if(document.getElementById("customer").checked){
                        window.location = "man_search_customer.php";
                    }if(document.getElementById("insurance").checked){
                        window.location = "man_search_insurance.php";
                    }if(document.getElementById("incident").checked){
                        window.location = "man_search_incident.php";
                    }if(document.getElementById("rental").checked){
                        window.location = "man_search_customer_rents_car.php";
                    }
                }
            </script>
