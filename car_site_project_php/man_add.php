    ...
    <div class="container">
        ...
        <div class = "search-box">
            ...
            <div class = "show">
                ...
                <label class = "box-label"> What table would you like to add to?</label> <br>
